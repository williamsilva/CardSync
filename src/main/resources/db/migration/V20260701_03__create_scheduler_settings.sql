CREATE TABLE cs_scheduler_settings (
  ...
  PRIMARY KEY (id),
  CONSTRAINT fk_cs_scheduler_settings_created_by FOREIGN KEY (created_by_id) REFERENCES cs_users (id),
  CONSTRAINT fk_cs_scheduler_settings_updated_by FOREIGN KEY (updated_by_id) REFERENCES cs_users (id)
);
