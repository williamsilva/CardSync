...
CREATE TABLE cs_installment_erp (
  ...
  reconciliation_payment_processed_at TIMESTAMP(6) NULL,
  reconciliation_bank_file_id UUID NULL,
  reconciliation_payment_file_id UUID NULL,
...
ALTER TABLE cs_transaction_erp ADD COLUMN transaction_acq_id UUID NULL;
...
ALTER TABLE cs_transaction_erp
  ADD COLUMN commercial_status VARCHAR(40) NULL,
  ADD COLUMN commercial_status_message VARCHAR(500) NULL;

CREATE INDEX idx_cs_transaction_erp_commercial_status ON cs_transaction_erp(commercial_status);

ALTER TABLE cs_transaction_erp
  ADD COLUMN source_company_cnpj VARCHAR(32) NULL,
  ADD COLUMN source_company_name VARCHAR(255) NULL,
  ADD COLUMN source_establishment_pv_number INT NULL;
