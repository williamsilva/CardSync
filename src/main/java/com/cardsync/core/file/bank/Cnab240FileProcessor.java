...
public class Cnab240FileProcessor {
  ...
  private ReleasesBankEntity buildRelease(
    ...
    release.setReleaseCategory(ReleaseCategoryEnum.fromCodeOrAlias(releaseCategory));
    release.setModalityPaymentBank(ModalityPaymentBankEnum.fromCodeOrAlias(classification.getModalityPaymentBank()));
