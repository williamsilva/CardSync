...
@Component
public class InstallmentsErpTableFields {

  private final DateFilterService dateFilterService;

  public InstallmentsErpTableFields(DateFilterService dateFilterService) {
    this.dateFilterService = dateFilterService;
  }

  public Map<String, FieldSpec<InstallmentErpEntity, ?>> table() {
    return Map.ofEntries(
      ...
      Map.entry("establishment",
        FieldSpec.integer(
          "establishment",
          (root, query) -> root.join("transaction", JoinType.LEFT)
            .join("establishment", JoinType.LEFT)
            .get("pvNumber")
        )),
