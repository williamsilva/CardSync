...
public class ChargeBackRequestsAdvancedFields extends BaseSpecificationSupport<RequestNoticeEntity> {
  ...
  private Specification<RequestNoticeEntity> currencyRange(String field, BigDecimal start, BigDecimal end) {
  ...
  private Specification<RequestNoticeEntity> inCollection(String field, java.util.List<Integer> values) {
