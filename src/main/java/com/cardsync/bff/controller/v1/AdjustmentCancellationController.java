...
import com.cardsync.domain.service.AdjustmentCancellationService;
...
public class AdjustmentCancellationController {

  private final AdjustmentCancellationService adjustmentService;
  ...
  public PagedModel<AdjustmentCancellationModel> search(@RequestBody ListQueryDto<AdjustmentFilter> body) {
    ...
    Page<AdjustmentCancellationModel> page = adjustmentService.search(pageable, body);
  ...
  @CheckSecurity.FileProcessing.CanRead
  public AdjustmentTotalsModel totals(@RequestBody ListQueryDto<AdjustmentFilter> body) {
