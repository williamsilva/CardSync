...
public class NoFileDayController {
  ...
  @PostMapping("/search")
  @CheckSecurity.Register.NoFileDays.CanConsult
  ...
  @CheckSecurity.Register.NoFileDays.CanCreate
  ...
  @PutMapping("/{id}")
  @CheckSecurity.Register.NoFileDays.CanChange
  ...
  @CheckSecurity.Register.NoFileDays.CanDelete
  ...
  @CheckSecurity.Register.NoFileDays.CanActiveOrInactive
