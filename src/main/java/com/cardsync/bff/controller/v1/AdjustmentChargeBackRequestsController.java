...
public class AdjustmentChargeBackRequestsController {

  private final AdjustmentChargeBackRequestsService adjustmentService;

  /**
   * Busca paginada de chargeback-requests.
   *
  ...
  public PagedModel<AdjustmentChargeBackRequestsModel> search(@RequestBody ListQueryDto<AdjustmentChargeBackRequestsFilter> body) {
    ...
    Page<AdjustmentChargeBackRequestsModel> page = adjustmentService.search(pageable, body);
