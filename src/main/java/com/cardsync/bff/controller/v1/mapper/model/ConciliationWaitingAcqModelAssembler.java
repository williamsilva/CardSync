...
@Component
public class ConciliationWaitingAcqModelAssembler extends RepresentationModelAssemblerSupport<
  @NonNull TransactionAcqEntity,
  @NonNull ConciliationWaitingModel
  > {

  public ConciliationWaitingAcqModelAssembler() {
    super(ConciliationWaitingController.class, ConciliationWaitingModel.class);
  }

  @Override
  public @NonNull ConciliationWaitingModel toModel(@NonNull TransactionAcqEntity entity) {
