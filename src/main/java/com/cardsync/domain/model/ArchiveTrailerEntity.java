...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "cs_archive_trailer")
public class ArchiveTrailerEntity extends AuditableEntityBase {

  private Integer lineNumber;
  private String recordType;
  private Integer numberMatrices;
  private Integer numberRecords;
  private Integer pvRequesting;
  private Integer normalCreditsQuantity;
  private BigDecimal totalValueRv;
  private Integer advanceCreditAmount;
  private BigDecimal totalValueUpfront;
  private Integer amountCreditAdjustments;
  private BigDecimal totalValueCreditAdjustments;
  private Integer debitAdjustmentQuantity;
  private BigDecimal totalValueDebit;
